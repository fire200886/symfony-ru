...
<div class="column_02">
  ...
  <div class="box_title">
    <h1 class="title_01">timezone Field Type</h1>
  </div>
  ...
  <div class="box_article doc_page">
    ...
    <div class="section" id="timezone-field-type">
      <span id="index-0"></span><h1>timezone Field Type<a class="headerlink" href="#timezone-field-type" title="Permalink to this headline">¶</a></h1>
      <p>See <tt class="docutils literal"><a class="reference external" href="http://api.symfony.com/2.0/Symfony/Component/Form/Type/TimezoneType.html" title="Symfony\Component\Form\Type\TimezoneType"><span class="pre">TimezoneType</span></a></tt>.</p>
      <p>The <tt class="docutils literal"><span class="pre">timezone</span></tt> type is a subset of the <tt class="docutils literal"><span class="pre">ChoiceType</span></tt> that allows the user
	to select from all possible timezones.</p>
      <p>The "value" for each timezone is the full timezone name, such as <tt class="docutils literal"><span class="pre">America/Chicago</span></tt>
	or <tt class="docutils literal"><span class="pre">Europe/Istanbul</span></tt>.</p>
	...
	of locales. You <em>can</em> specify either of these options manually, but then
	...
	<tbody valign="top">
	  ...
	  <tr><td>Class</td>
	    <td><tt class="docutils literal"><a class="reference external" href="http://api.symfony.com/2.0/Symfony/Component/Form/Extension/Core/Type/TimezoneType.html" title="Symfony\Component\Form\Extension\Core\Type\TimezoneType"><span class="pre">TimezoneType</span></a></tt></td>
	  </tr>
	</tbody>
      </table>
...
<span class="p">));</span>
  ...
  <div class="navigation">
    <a accesskey="P" title="time Field Type" href="time.html">
      «&nbsp;time Field Type
    </a><span class="separator">|</span>
    <a accesskey="N" title="url Field Type" href="url.html">
      url Field Type&nbsp;»
    </a>
  </div>
