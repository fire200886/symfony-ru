...
<div class="column_02">
  ...
  <div class="box_title">
    <h1 class="title_01">country Field Type</h1>
  </div>
  ...
  <div class="box_article doc_page">
    ...
    <div class="section" id="country-field-type">
      <span id="index-0"></span><h1>country Field Type<a class="headerlink" href="#country-field-type" title="Permalink to this headline">¶</a></h1>
      <p>The <tt class="docutils literal"><span class="pre">country</span></tt> type is a subset of the <tt class="docutils literal"><span class="pre">ChoiceType</span></tt> that displays countries
	of the world. As an added bonus, the country names are displayed in the language
	of the user.</p>
      <p>The "value" for each country is the two-letter country code.</p>
	...
	<tt class="docutils literal"><span class="pre">choice_list</span></tt> option as the field type automatically uses all of the countries
	of the world. You <em>can</em> specify either of these options manually, but then
	...
	<tbody valign="top">
	  ...
	  <tr><td>Class</td>
	    <td><tt class="docutils literal"><a class="reference external" href="http://api.symfony.com/2.0/Symfony/Component/Form/Extension/Core/Type/CountryType.html" title="Symfony\Component\Form\Extension\Core\Type\CountryType"><span class="pre">CountryType</span></a></tt></td>
	  </tr>
	</tbody>
      </table>
...
<span class="p">));</span>
  ...
  <div class="navigation">
    <a accesskey="P" title="collection Field Type" href="collection.html">
      «&nbsp;collection Field Type
    </a><span class="separator">|</span>
    <a accesskey="N" title="csrf Field Type" href="csrf.html">
      csrf Field Type&nbsp;»
    </a>
  </div>
