...
<div class="column_02">
  ...
  <div class="box_title">
    <h1 class="title_01">textarea Field Type</h1>
  </div>
  ...
  <div class="box_article doc_page">
    ...
    <div class="section" id="textarea-field-type">
      <span id="index-0"></span><h1>textarea Field Type<a class="headerlink" href="#textarea-field-type" title="Permalink to this headline">¶</a></h1>
      <p>Renders a <tt class="docutils literal"><span class="pre">textarea</span></tt> HTML element.</p>
	...
	<tbody valign="top">
	  <tr><td>Rendered as</td>
	    <td><tt class="docutils literal"><span class="pre">textarea</span></tt> field</td>
	  </tr>
	  <tr><td>Options</td>
	  ...
	  <tr><td>Class</td>
	    <td><tt class="docutils literal"><a class="reference external" href="http://api.symfony.com/2.0/Symfony/Component/Form/Extension/Core/Type/TextareaType.html" title="Symfony\Component\Form\Extension\Core\Type\TextareaType"><span class="pre">TextareaType</span></a></tt></td>
	  </tr>
	</tbody>
      </table>
  ...
  <div class="navigation">
    <a accesskey="P" title="text Field Type" href="text.html">
      «&nbsp;text Field Type
    </a><span class="separator">|</span>
    <a accesskey="N" title="time Field Type" href="time.html">
      time Field Type&nbsp;»
    </a>
  </div>
