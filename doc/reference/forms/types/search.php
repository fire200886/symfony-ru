...
<div class="column_02">
  ...
  <div class="box_title">
    <h1 class="title_01">search Field Type</h1>
  </div>
  ...
  <div class="box_article doc_page">
    ...
    <div class="section" id="search-field-type">
      <span id="index-0"></span><h1>search Field Type<a class="headerlink" href="#search-field-type" title="Permalink to this headline">¶</a></h1>
      <p>The <tt class="docutils literal"><span class="pre">search</span></tt> field is a text field that is used for the entry of searches,
	and is rendered by default using a <tt class="docutils literal"><span class="pre">search</span></tt> input type which can be used
	by user agents to present a specialized rendering for search boxes (such
	as the <a class="reference external" href="http://alexking.org/blog/2006/11/12/safari-search-boxes">one used in WebKit-based browsers</a>).</p>
	...
	<tbody valign="top">
	  <tr><td>Rendered as</td>
	    <td><tt class="docutils literal"><span class="pre">input</span> <span class="pre">search</span></tt> field</td>
	  </tr>
	  <tr><td>Inherited
	      options</td>
	  ...
	  <tr><td>Class</td>
	    <td><tt class="docutils literal"><a class="reference external" href="http://api.symfony.com/2.0/Symfony/Component/Form/Extension/Core/Type/SearchType.html" title="Symfony\Component\Form\Extension\Core\Type\SearchType"><span class="pre">SearchType</span></a></tt></td>
	  </tr>
	</tbody>
      </table>
  ...
  <div class="navigation">
    <a accesskey="P" title="repeated Field Type" href="repeated.html">
      «&nbsp;repeated Field Type
    </a><span class="separator">|</span>
    <a accesskey="N" title="text Field Type" href="text.html">
      text Field Type&nbsp;»
    </a>
  </div>
