...
<div class="column_02">
  ...
  <div class="box_title">
    <h1 class="title_01">radio Field Type</h1>
  </div>
  ...
  <div class="box_article doc_page">
    ...
    <div class="section" id="radio-field-type">
      <span id="index-0"></span><h1>radio Field Type<a class="headerlink" href="#radio-field-type" title="Permalink to this headline">¶</a></h1>
      <p>Creates a single radio button. This should always be used for a field that
	has a Boolean value: if the radio button is selected, the field will be set
	to true, if the button is not selected, the value will be set to false.</p>
      <p>The <tt class="docutils literal"><span class="pre">radio</span></tt> type isn't usually used directly. More commonly it's used
	internally by other types such as <a class="reference internal" href="choice.html"><em>choice</em></a>.
	If you want to have a Boolean field, use <a class="reference internal" href="checkbox.html"><em>checkbox</em></a>.</p>
	...
	<tbody valign="top">
	  ...
	  <tr><td>Class</td>
	    <td><tt class="docutils literal"><a class="reference external" href="http://api.symfony.com/2.0/Symfony/Component/Form/Extension/Core/Type/RadioType.html" title="Symfony\Component\Form\Extension\Core\Type\RadioType"><span class="pre">RadioType</span></a></tt></td>
	  </tr>
	</tbody>
      </table>
	...
	<ul>
	  <li><dl class="first docutils">
	      ...
	      <dd><p class="first last">The value that's actually used as the value for the radio button. This does
  ...
  <div class="navigation">
    <a accesskey="P" title="percent Field Type" href="percent.html">
      «&nbsp;percent Field Type
    </a><span class="separator">|</span>
    <a accesskey="N" title="repeated Field Type" href="repeated.html">
      repeated Field Type&nbsp;»
    </a>
  </div>
