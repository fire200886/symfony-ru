...
<div class="column_02">
  ...
  <div class="box_title">
    <h1 class="title_01">locale Field Type</h1>
  </div>
  ...
  <div class="box_article doc_page">
    ...
    <div class="section" id="locale-field-type">
      <span id="index-0"></span><h1>locale Field Type<a class="headerlink" href="#locale-field-type" title="Permalink to this headline">¶</a></h1>
      <p>The <tt class="docutils literal"><span class="pre">locale</span></tt> type is a subset of the <tt class="docutils literal"><span class="pre">ChoiceType</span></tt> that allows the user
	to select from a large list of locales (language+country). As an added bonus,
	the locale names are displayed in the language of the user.</p>
      <p>The "value" for each locale is either the two letter ISO639-1 <em>language</em> code
	(e.g. <tt class="docutils literal"><span class="pre">fr</span></tt>), or the language code followed by an underscore (<tt class="docutils literal"><span class="pre">_</span></tt>), then
	the ISO3166 <em>country</em> code (e.g. <tt class="docutils literal"><span class="pre">fr_FR</span></tt> for French/France).</p>
...
<span class="p">));</span>
  ...
  <div class="navigation">
    <a accesskey="P" title="language Field Type" href="language.html">
      «&nbsp;language Field Type
    </a><span class="separator">|</span>
    <a accesskey="N" title="money Field Type" href="money.html">
      money Field Type&nbsp;»
    </a>
  </div>
