...
<div class="column_02">
  ...
  <div class="box_title">
    <h1 class="title_01">text Field Type</h1>
  </div>
  ...
  <div class="box_article doc_page">
    ...
    <div class="section" id="text-field-type">
      <span id="index-0"></span><h1>text Field Type<a class="headerlink" href="#text-field-type" title="Permalink to this headline">¶</a></h1>
      <p>The text field represents the most basic input text field.</p>
	...
	<tbody valign="top">
	  ...
	  <tr><td>Class</td>
	    <td><tt class="docutils literal"><a class="reference external" href="http://api.symfony.com/2.0/Symfony/Component/Form/Extension/Core/Type/TextType.html" title="Symfony\Component\Form\Extension\Core\Type\TextType"><span class="pre">TextType</span></a></tt></td>
	  </tr>
	</tbody>
      </table>
  ...
  <div class="navigation">
    <a accesskey="P" title="search Field Type" href="search.html">
      «&nbsp;search Field Type
    </a><span class="separator">|</span>
    <a accesskey="N" title="textarea Field Type" href="textarea.html">
      textarea Field Type&nbsp;»
    </a>
  </div>
