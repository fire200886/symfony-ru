...
<div class="column_02">
  ...
  <div class="box_title">
    <h1 class="title_01">password Field Type</h1>
  </div>
  ...
  <div class="box_article doc_page">
    ...
    <div class="section" id="password-field-type">
      <span id="index-0"></span><h1>password Field Type<a class="headerlink" href="#password-field-type" title="Permalink to this headline">¶</a></h1>
      <p>The <tt class="docutils literal"><span class="pre">password</span></tt> field renders an input password text box.</p>
	...
	<tbody valign="top">
	  <tr><td>Rendered as</td>
	    <td><tt class="docutils literal"><span class="pre">input</span></tt> <tt class="docutils literal"><span class="pre">password</span></tt> field</td>
	  </tr>
	  <tr><td>Options</td>
	    <td><ul class="first last simple">
		<li><tt class="docutils literal"><span class="pre">always_empty</span></tt></li>
	  ...
	  <tr><td>Class</td>
	    <td><tt class="docutils literal"><a class="reference external" href="http://api.symfony.com/2.0/Symfony/Component/Form/Extension/Core/Type/PasswordType.html" title="Symfony\Component\Form\Extension\Core\Type\PasswordType"><span class="pre">PasswordType</span></a></tt></td>
	  </tr>
	</tbody>
      </table>
	...
	<ul>
	  <li><dl class="first docutils">
	      <dt><tt class="docutils literal"><span class="pre">always_empty</span></tt> [type: Boolean, default: true]</dt>
	      <dd><p class="first">If set to true, the field will <em>always</em> render blank, even if the corresponding
		  field has a value. When set to false, the password field will be rendered
		  with the <tt class="docutils literal"><span class="pre">value</span></tt> attribute set to its true value.</p>
		<p class="last">Put simply, if for some reason you want to render your password field
		  <em>with</em> the password value already entered into the box, set this to false.</p>
	      </dd>
	    </dl>
	  </li>
	</ul>
  ...
  <div class="navigation">
    <a accesskey="P" title="number Field Type" href="number.html">
      «&nbsp;number Field Type
    </a><span class="separator">|</span>
    <a accesskey="N" title="percent Field Type" href="percent.html">
      percent Field Type&nbsp;»
    </a>
  </div>
