...
<div class="column_02">
  ...
  <div class="box_title">
    <h1 class="title_01">10 критериев выбора фреймворка</h1>
  </div>
  ...
  <div class="box_article">
    <h2 class="title_09">1.	Popularity and community size</h2>
    <p>
  ...
  <div class="box_article">
    <h2 class="title_09">2.	Philosophy</h2>
    <p>
  ...
  <div class="box_article">
    <h2 class="title_09">3.	Sustainability</h2>
    <p>
  ...
  <div class="box_article">
    <h2 class="title_09">4.	Support</h2>
    <p>
  ...
  <div class="box_article">
    <h2 class="title_09">5.	Technique</h2>
    <p>
      To avoid becoming trapped in a labyrinth, it is always preferable to choose an interoperable solution; one that respects best practices in terms of development (<i>design patterns</i>)
    </p>
  </div>
  ...
  <div class="box_article">
    <h2 class="title_09">6.	Security</h2>
    <p>
  ...
  <div class="box_article">
    <h2 class="title_09">7.	Documentation</h2>
    <p>
  ...
  <div class="box_article">
    <h2 class="title_09">8.	License</h2>
    <p>
  ...
  <div class="box_article">
    <h2 class="title_09">9.	Availability of resources on the market</h2>
    <p>
  ...
  <div class="box_article">
    <h2 class="title_09">10.	Try it out!</h2>
    <p>
  ...
  <div class="box_page_summary clear_fix">
    ...
    <div class="article_text">
      <p>Choosing a framework must not be taken lightly; it is a long-term commitment.  Make sure that you make the right selection! </p>
    </div>
  </div>
</div>
